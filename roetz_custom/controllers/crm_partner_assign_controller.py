...
from openerp.addons.website_crm_partner_assign.controllers.main import (
    WebsiteCrmPartnerAssign
)


class CrmPartnerAssignController(WebsiteCrmPartnerAssign):
    ...
    def partners(self, country=None, grade=None, page=0, **post):
        """ Overwrite of this method to work on cities instead of partner
        grades. Changes marked with 'Custom' """
        ...
        # remove me in trunk
        # Custom: disable resorting on grade
